...
export const TRANSLATIONS = {
  pl: {
    app: {
      ...
      tabs: { generator: 'Generator', batch: 'Batch', labels: 'Etykiety', mySheets: 'Moje arkusze' },
      lang: 'J\u0119zyk',
    },
    codesGroup: {
      popular: 'Popularne',
    ...
    sheets: {
      title: 'Moje arkusze',
      count: 'Arkuszy: {count}',
      empty: 'Brak zapisanych arkuszy.',
      saveCurrent: 'Zapisz arkusz',
      defaultName: 'Arkusz',
      saveTitle: 'Zapisz arkusz',
      renameTitle: 'Zmień nazwę arkusza',
      namePlaceholder: 'Nazwa arkusza',
      confirm: 'Zapisz',
      cancel: 'Anuluj',
      rename: 'Zmień nazwę',
      delete: 'Usuń',
      open: 'Otwórz arkusz',
      searchPlaceholder: 'Szukaj po nazwie lub zawartości kodów...',
      clearSearch: 'Wyczyść',
      matchPreview: 'Podgląd trafionego kodu',
      matchIndex: 'Pozycja na arkuszu: {index}',
      matchCaption: 'Podpis',
      matchType: 'Typ',
      matchNoCode: 'Dopasowanie dotyczy nazwy arkusza, nie konkretnego kodu.',
      deleteTitle: 'Usuń arkusz',
      deleteQuestion: 'Czy na pewno usunąć arkusz: "{name}"?',
      deleteConfirm: 'Usuń',
      untitled: 'Bez nazwy',
      saved: 'Arkusz zapisany',
      loaded: 'Arkusz wczytany',
      deleted: 'Arkusz usunięty',
      renamed: 'Nazwa zaktualizowana',
      nothingToSave: 'Brak etykiet do zapisania',
    },
    generator: {
    ...
    batch: {
      ...
      captionMode: 'Podpis po separatorze',
      captionSeparator: 'Separator',
      captionHelp: 'Format: kod{sep}podpis. Gdy brak separatora lub podpisu, etykieta dostaje tylko kod.',
      ...
      addedMany: 'Dodano {count} etykiet',
    ...
    codes: {
      ...
      microqrcode: { label: 'Micro QR', note: 'Mniejsza wersja QR dla krótkich danych.' },
      maxicode: { label: 'MaxiCode', note: 'Kod 2D dla logistyki/transportu.' },
      datamatrix: { label: 'Data Matrix', note: 'Ma\u0142e etykiety, GS1.' },
      gs1datamatrix: { label: 'GS1 Data Matrix', note: 'Data Matrix dla GS1 (AI/FNC1).' },
      ...
      code93: { label: 'Code 93', note: 'G\u0119sty kod 1D, rozszerzenie Code 39.' },
      code39: { label: 'Code 39', note: 'Klasyczny 1D, litery/cyfry i znaki specjalne.' },
      code39ext: { label: 'Code 39 Extended', note: 'Pe\u0142ne ASCII przez sekwencje Code 39.' },
      codabar: { label: 'Codabar', note: 'Medycyna/logistyka, start/stop A-D.' },
      interleaved2of5: { label: 'Interleaved 2 of 5', note: 'Numeryczny 1D, parzysta liczba cyfr.' },
      code11: { label: 'Code 11', note: 'Telekomunikacja, cyfry i my\u015blnik.' },
      msi: { label: 'MSI', note: 'Numeryczny 1D, cz\u0119sto do inwentaryzacji.' },
      hibccode39: { label: 'HIBC Code 39', note: 'Healthcare HIBC LIC na bazie Code 39.' },
      hibcdatamatrix: { label: 'HIBC Data Matrix', note: 'Healthcare HIBC LIC w 2D Data Matrix.' },
      ean13: { label: 'EAN-13', note: '12-13 cyfr (ostatnia kontrolna).' },
      ean8: { label: 'EAN-8', note: '7-8 cyfr (ostatnia kontrolna).' },
      upca: { label: 'UPC-A', note: '11-12 cyfr (detal USA/CA).' },
      upce: { label: 'UPC-E', note: 'Skr\u00f3cony UPC, 6-8 cyfr.' },
    ...
    labels: {
      ...
      showSlots: 'Poka\u017c pola podgl\u0105du',
      showCutLines: 'Linie ci\u0119cia (PDF/druk)',
      cutLineWeight: 'Grubo\u015b\u0107 linii',
      cutWeightThin: 'Cienkie',
      cutWeightStandard: 'Standard',
      cutWeightThick: 'Grube',
      cutLineStyle: 'Styl linii',
      cutStyleSolid: 'Ci\u0105g\u0142e',
      cutStyleDashed: 'Przerywane',
      ...
      deletedOne: 'Usuni\u0119to etykiet\u0119',
      deletedMany: 'Usuni\u0119to etykiet: {count}',
    },
    gs1: {
    ...
    errors: {
      ...
      code11badcharacter: 'Code 11 zawiera niedozwolony znak',
      msibadcharacter: 'MSI akceptuje tylko cyfry',
  ...
  en: {
    app: {
      title: 'Realtime Barcode & QR Studio',
      tabs: { generator: 'Generator', batch: 'Batch', labels: 'Labels', mySheets: 'My sheets' },
      lang: 'Language',
    },
    codesGroup: {
      popular: 'Popular',
    ...
    sheets: {
      title: 'My sheets',
      count: 'Sheets: {count}',
      empty: 'No saved sheets yet.',
      saveCurrent: 'Save sheet',
      defaultName: 'Sheet',
      saveTitle: 'Save sheet',
      ...
      delete: 'Delete',
      open: 'Open sheet',
      searchPlaceholder: 'Search by sheet name or code content...',
      clearSearch: 'Clear',
      matchPreview: 'Matched code preview',
      matchIndex: 'Position on sheet: {index}',
      matchCaption: 'Caption',
      matchType: 'Type',
      matchNoCode: 'The match is in sheet name, not in a specific code.',
      ...
      nothingToSave: 'No labels to save',
    },
    generator: {
    ...
    batch: {
      ...
      captionMode: 'Caption after separator',
      captionSeparator: 'Separator',
      captionHelp: 'Format: code{sep}caption. If separator/caption is missing, only code content is used.',
    ...
    codes: {
      ...
      microqrcode: { label: 'Micro QR', note: 'Smaller QR variant for short payloads.' },
      maxicode: { label: 'MaxiCode', note: '2D symbol for logistics/transport.' },
      datamatrix: { label: 'Data Matrix', note: 'Small labels, GS1.' },
      gs1datamatrix: { label: 'GS1 Data Matrix', note: 'Data Matrix for GS1 (AI/FNC1).' },
      ...
      code93: { label: 'Code 93', note: 'Dense 1D symbology, Code 39 extension.' },
      code39: { label: 'Code 39', note: 'Classic 1D with letters/digits and symbols.' },
      code39ext: { label: 'Code 39 Extended', note: 'Full ASCII via Code 39 sequences.' },
      codabar: { label: 'Codabar', note: 'Healthcare/logistics, A-D start/stop.' },
      interleaved2of5: { label: 'Interleaved 2 of 5', note: 'Numeric 1D, even number of digits.' },
      code11: { label: 'Code 11', note: 'Telecom usage, digits and hyphen.' },
      msi: { label: 'MSI', note: 'Numeric 1D, common in inventory use.' },
      hibccode39: { label: 'HIBC Code 39', note: 'Healthcare HIBC LIC based on Code 39.' },
      hibcdatamatrix: { label: 'HIBC Data Matrix', note: 'Healthcare HIBC LIC in 2D Data Matrix.' },
      ean13: { label: 'EAN-13', note: '12-13 digits (last is check).' },
      ean8: { label: 'EAN-8', note: '7-8 digits (last is check).' },
      upca: { label: 'UPC-A', note: '11-12 digits (US/CA retail).' },
      upce: { label: 'UPC-E', note: 'Compressed UPC, 6-8 digits.' },
    ...
    labels: {
      ...
      showSlots: 'Show preview slots',
      showCutLines: 'Cut lines (PDF/print)',
      cutLineWeight: 'Line weight',
      cutWeightThin: 'Thin',
      cutWeightStandard: 'Standard',
      cutWeightThick: 'Thick',
      cutLineStyle: 'Line style',
      cutStyleSolid: 'Solid',
      cutStyleDashed: 'Dashed',
      editMode: 'Edit mode',
      ...
      deletedMany: 'Deleted labels: {count}',
    },
    gs1: {
    ...
    errors: {
      ...
      code11badcharacter: 'Code 11 contains an invalid character',
      msibadcharacter: 'MSI accepts digits only',
