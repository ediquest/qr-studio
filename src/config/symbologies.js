...
export const SYMBOLOGIES = [
  ...
  { id: "upca",    label: "UPC‑A",     bcid: "upca",    placeholder: "03600029145",      pattern: /^[0-9]{11,12}$/ },
  { id: "upce",    label: "UPC‑E",     bcid: "upce",    placeholder: "04210005",         pattern: /^[0-9]{6,8}$/ },
  { id: "code128", label: "Code 128",  bcid: "code128", placeholder: "ABC123-xyz",       pattern: /^[\x00-\x7F]{1,100}$/ },
  { id: "code39",  label: "Code 39",   bcid: "code39",  placeholder: "CODE39-123",       pattern: /^[ 0-9A-Z\-\.\$/+%*]{1,100}$/ },
...
export function normalizeInput(symId, value) {
  ...
  if (["ean13","ean8","upca","upce","itf14"].includes(symId)) {
    v = v.replace(/[^0-9]/g,"");
  }
  return v;
}
